...
class Process implements CommandInterface
{
    ...
    public function help(array $args): ?string
    {
        ...
        return $logo . "
php rayswoole process kill PID [-p] [-d]
php rayswoole process kill PID [-f] [-p] [-d]
php rayswoole process kill GroupName [-f] [-d]
php rayswoole process killAll [-d]
php rayswoole process killAll -f [-d]
php rayswoole process show
php rayswoole process show -d
";
    }
}
